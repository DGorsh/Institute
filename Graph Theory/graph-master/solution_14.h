#ifndef SOLUTION_14_H
#define SOLUTION_14_H
...
public:
    ...
    QPair<MGraphObject, int> pallite_BFS(MGraphObject& in_graph, int fromId);
    QPair<MGraphObject, int> pallite_new(MGraphObject& in_graph, int fromId) {
        ...
        while(!Q.isEmpty() && maxIterations++ < 100) {
            unsigned v = Q.front();
            Q.pop_front();
