#ifndef SOLUTION_21_H
#define SOLUTION_21_H
...
public:
    ...
    void djikstra(MMatrix& graph, int fromId, int toId) {
        ...
        QVector<int> distances(graph.size(), INF);
        QVector<int> parents(graph.size(), MConstants::not_exists);
